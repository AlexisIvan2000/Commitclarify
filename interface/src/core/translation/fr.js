const fr = {
  ...
  errors: {
    ...
    streamLost: 'Connexion au flux perdue. Le scan continue sur le serveur : reprenez le suivi.',
    scanFailed: 'Le scan a échoué. Relancez-le depuis vos dépôts.',
  ...
  runs: {
    ...
    deepenDone: 'Analyse IA terminée',
    failed: 'L’analyse a échoué',
    openReport: 'Voir le rapport',
    busyTitle: 'Une analyse est déjà en cours',
    busyText: 'Le scan de {repo} tourne encore. Attendez qu’il se termine avant d’en lancer un autre.',
    followIt: 'Suivre cette analyse',
  ...
  apiErrors: {
    ...
    scan_throttled: 'Trop de scans lancés coup sur coup. Réessayez dans {seconds} secondes.',
    run_in_flight: 'Une analyse est déjà en cours sur votre compte. Attendez qu\'elle se termine.',
    run_interrupted: 'Le serveur a interrompu cette analyse. Relancez-la.',
    run_failed: 'L\'analyse a échoué.',
    scan_required: 'Le scan doit être terminé avant de lancer l\'analyse IA.',
    rate_limited: 'Trop de requêtes. Réessayez dans {seconds} secondes.',
    quota_exceeded: 'Vous avez utilisé vos {limit} tris IA du jour. Le scan reste disponible.',
  ...
  analysis: {
    ...
    reconnecting: 'Connexion perdue, reprise du suivi…',
    stepperLabels: {
    ...
    folded: '{count} détection(s)',
    foldedGrouped: '{detections} détections en {entries} entrées',
    relative: {
      justNow: 'à l’instant',
    ...
    lastScan: {
      ...
      failed: 'dernier scan échoué',
      done: 'scanné {when}',
    },
    reposNoMatchTitle: 'Aucun dépôt ne correspond',
    reposNoMatchText: 'Aucun de vos {count} dépôts ne correspond à cette recherche.',
    reposEmptyTitle: 'Aucun dépôt sur ce compte',
    reposEmptyText: 'Le compte GitHub connecté ne contient aucun dépôt.',
    confirmDeleteAllTitle: 'Supprimer les {count} analyses ?',
    confirmDeleteAllText: 'Leurs rapports, leurs détections et leurs exports disparaîtront définitivement. Vos dépôts GitHub ne sont pas touchés.',
    severityLabels: {
      critical: 'Critique',
      high: 'Élevée',
      medium: 'Moyenne',
    ...
    chunkCoverage: {
      lead: '{indexed} fragments indexés sur {total} pour la recherche IA :',
      breakdown: 'le reste est {detail}',
      involuntary: '{count} fragments de code source n’ont pas pu être indexés : le dépôt dépasse la limite',
      tiers: {
        genere_ou_vendored: 'du généré ou du vendored',
        tests: 'des fichiers de test',
        source: 'du code source',
