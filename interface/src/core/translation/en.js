const en = {
  ...
  analysis: {
    ...
    folded: '{count} detection(s)',
    foldedGrouped: '{detections} detections in {entries} entries',
    relative: {
      justNow: 'just now',
    ...
    reposNoMatchTitle: 'No repository matches',
    reposNoMatchText: 'None of your {count} repositories matches this search.',
    reposEmptyTitle: 'No repository on this account',
    reposEmptyText: 'The connected GitHub account has no repository.',
    confirmDeleteAllTitle: 'Delete the {count} analyses?',
    confirmDeleteAllText: 'Their reports, detections and exports will be gone for good. Your GitHub repositories are untouched.',
    severityLabels: {
      critical: 'Critical',
      high: 'High',
      medium: 'Medium',
